...
function(){const e=document.querySelectorAll(".rating");e.length>0&&function(){let t,s;for(let t=0;t<e.length;t++){i(e[t])}function i(e){n(e),a(),e.classList.contains("rating_set")&&r(e)}function n(e){t=e.querySelector(".rating__active"),s=e.querySelector(".rating__value")}function a(e=s.innerHTML){const i=e/.05;t.style.width=`${i}%`}function r(e){const t=e.querySelectorAll(".rating__item");for(let i=0;i<t.length;i++){const r=t[i];r.addEventListener("mouseenter",(function(t){n(e),a(r.value)})),r.addEventListener("mouseleave",(function(e){a()})),r.addEventListener("click",(function(t){n(e),e.dataset.ajax?l(r.value,e):(s.innerHTML=i+1,a())}))}}async function l(e,t){if(!t.classList.contains("rating_sending")){t.classList.add("rating_sending");let e=await fetch("rating.json",{method:"GET"});if(e.ok){const i=(await e.json()).newRating;s.innerHTML=i,a(),t.classList.remove("rating_sending")}else alert("Ошибка"),t.classList.remove("rating_sending")}}}()}()})
